...
public class UsuarioDao {
     ...
     */
    public Usuario getObject(Connection conn, int codigo_usuario) throws NotFoundException, SQLException {

          Usuario valueObject = createValueObject();
          valueObject.setCodigo_usuario(codigo_usuario);
    ...
    public void load(Connection conn, Usuario valueObject) throws NotFoundException, SQLException {
          ...
          try {
               ...
               stmt.setInt(1, valueObject.getCodigo_usuario()); 
    ...
    public List loadAll(Connection conn) throws SQLException {
          ...
          String sql = "SELECT * FROM usuario ORDER BY codigo_usuario ASC ";
    ...
    public synchronized void create(Connection conn, Usuario valueObject) throws SQLException {
          ...
          try {
               sql = "INSERT INTO usuario ( codigo_usuario, id, nombre, "
    ...
    public void save(Connection conn, Usuario valueObject) 
          ...
          String sql = "UPDATE usuario SET id = ?, nombre = ?, apellido = ?, "
               + "telefono = ?, email = ?, tipo = ? WHERE (codigo_usuario = ? ) ";
          PreparedStatement stmt = null;
    ...
    public List searchMatching(Connection conn, Usuario valueObject) throws SQLException {
          ...
          if (valueObject.getCodigo_usuario() != 0) {
              if (first) { first = false; }
              sql.append("AND codigo_usuario = ").append(valueObject.getCodigo_usuario()).append(" ");
          }
          ...
          if (valueObject.getApellido() != null) {
              if (first) { first = false; }
              sql.append("AND apellido LIKE '").append(valueObject.getApellido()).append("%' ");
          }
          ...
          sql.append("ORDER BY codigo_usuario ASC ");
    ...
    protected void singleQuery(Connection conn, PreparedStatement stmt, Usuario valueObject) 
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setCodigo_usuario(result.getInt("codigo_usuario")); 
    ...
    protected List listQuery(Connection conn, PreparedStatement stmt) throws SQLException {
          ...
          try {
              ...
              while (result.next()) {
                   ...
                   temp.setCodigo_usuario(result.getInt("codigo_usuario")); 
