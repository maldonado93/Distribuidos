...
public class Usuario implements Cloneable, Serializable {
    ...
    public Usuario (int codigo_usuarioIn) {
    ...
    public void setCodigo_usuario(int codigo_usuarioIn) {
          this.codigo_usuario = codigo_usuarioIn;
    }
    ...
    public void setAll(int codigo_usuarioIn,
          String idIn,
          String nombreIn,
          String apellidoIn,
          String telefonoIn,
    ...
    public boolean hasEqualMapping(Usuario valueObject) {
          ...
          if (valueObject.getCodigo_usuario() != this.codigo_usuario) {
                    return(false);
          }
          if (this.id == null) {
    ...
    public Object clone() {
        ...
        cloned.setCodigo_usuario(this.codigo_usuario); 
        if (this.id != null)
