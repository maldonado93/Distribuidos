...
public class Material implements Cloneable, Serializable {
    ...
    public Material (int codigo_materialIn) {
    ...
    public void setCodigo_material(int codigo_materialIn) {
          this.codigo_material = codigo_materialIn;
    }
    ...
    public void setAll(int codigo_materialIn,
    ...
    public boolean hasEqualMapping(Material valueObject) {
          ...
          if (valueObject.getCodigo_material() != this.codigo_material) {
                    return(false);
          }
    ...
    public Object clone() {
        ...
        cloned.setCodigo_material(this.codigo_material); 
        if (this.descripcion != null)
