...
public class MaterialDao {
     ...
     */
    public Material getObject(Connection conn, int codigo_material) throws NotFoundException, SQLException {

          Material valueObject = createValueObject();
          valueObject.setCodigo_material(codigo_material);
    ...
    public void load(Connection conn, Material valueObject) throws NotFoundException, SQLException {
          ...
          String sql = "SELECT * FROM material WHERE (codigo_material = ? ) "; 
          PreparedStatement stmt = null;

          try {
               stmt = conn.prepareStatement(sql);
               stmt.setInt(1, valueObject.getCodigo_material()); 
    ...
    public List loadAll(Connection conn) throws SQLException {
          ...
          String sql = "SELECT * FROM material ORDER BY codigo_material ASC ";
     ...
     */
    public synchronized void create(Connection conn, Material valueObject) throws SQLException {
          ...
          try {
               sql = "INSERT INTO material ( codigo_material, descripcion, tipo) VALUES (?, ?, ?) ";
               stmt = conn.prepareStatement(sql);
    ...
    public void save(Connection conn, Material valueObject) 
          ...
          String sql = "UPDATE material SET descripcion = ?, tipo = ? WHERE (codigo_material = ? ) ";
          PreparedStatement stmt = null;
          ...
          try {
              ...
              stmt.setInt(3, valueObject.getCodigo_material()); 
     ...
     *                     Primary-key field must be set for this to work properly.
     */
    public void delete(Connection conn, Material valueObject) 
          throws NotFoundException, SQLException {
     ...
     */
    public List searchMatching(Connection conn, Material valueObject) throws SQLException {

          List searchResults;

          boolean first = true;
          StringBuffer sql = new StringBuffer("SELECT * FROM material WHERE 1=1 ");

          if (valueObject.getCodigo_material() != 0) {
              if (first) { first = false; }
              sql.append("AND codigo_material = ").append(valueObject.getCodigo_material()).append(" ");
          }
          ...
          sql.append("ORDER BY codigo_material ASC ");
    ...
    protected void singleQuery(Connection conn, PreparedStatement stmt, Material valueObject) 
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setCodigo_material(result.getInt("codigo_material")); 
    ...
    protected List listQuery(Connection conn, PreparedStatement stmt) throws SQLException {
          ...
          try {
              ...
              while (result.next()) {
                   ...
                   temp.setCodigo_material(result.getInt("codigo_material")); 
